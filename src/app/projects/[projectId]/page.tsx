          ...
          <div className="p-8 lg:p-12">
            <div className="mb-8">
              ...
              {project.titleNp && (
                <h3
                  lang="ne"
                  className="text-2xl font-semibold text-muted-foreground mb-3"
                >
                  {project.titleNp}
                </h3>
              )}
            ...
            {/* Content with Full-Width Tables and Images, English and Nepali side by side */}
            <div className="grid gap-8 lg:grid-cols-2">
              <div>
                <h4 className="mb-4 text-base font-semibold text-muted-foreground">
                  Content (English)
                </h4>
                <div
                ...
                <div>
                  ...
                  <div
                    ...
                    className="prose prose-lg dark:prose-invert max-w-none
                                            ...
                                            [&_code]:bg-muted [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-sm
                                            [&_hr]:my-8 [&_hr]:border-border"
                    dangerouslySetInnerHTML={{ __html: project.contentNp }}
                  />
                </div>
              )}
            </div>
